                                    ...
                                    <div className="flex flex-col justify-center items-center">
                                        ...
                                        <div className="flex flex-row items-center text-center justify-center px-6 mx-auto md:w-1/2">
                                            ...
                                            <div className="px-6 py-3 my-3 mx-3 rounded-full bg-orange-500 text-white">
                                                <Link to="/checkout" state={{movieName: currMovie.movieName, price:10.00, ticketNum:quantity, theater:currShowTime.screenNum, time:(new Date(currShowTime.date + "T" + currShowTime.time)).toLocaleTimeString() }}>Checkout</Link>
                                            </div>
                                        </div>
                                    </div>
                                 </Modal>
